...
bool is_shift_active(void) {
	...
	return mods & MOD_BIT(KC_LSFT) || mods & MOD_BIT(KC_RSFT);
};

bool is_alt_active(void) {
	uint8_t mods = keyboard_report->mods;
	return mods & MOD_BIT(KC_LALT) || mods & MOD_BIT(KC_RALT);
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_LCTL, KC_Z, KC_X, KC_C,    KC_V,    KC_B,   CKC_LT, 	CKC_RT, KC_N,  KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
